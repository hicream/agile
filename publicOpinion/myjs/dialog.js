...
(function($) {
    ...
    function getjobj(type, title, content, okfun, canclfun, oktxt, cancltxt) {
    ...
    function alert(title, content, okfun) {
        show(getjobj("alert", title, content, okfun));
    }

    function confirm(title, content, okfun, canclfun, oktxt, cancltxt) {
        show(getjobj("confirm", title, content, okfun, canclfun, oktxt, cancltxt));
    }
